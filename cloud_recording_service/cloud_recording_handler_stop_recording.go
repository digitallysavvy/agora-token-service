...
// HandleStopRecording handles the stop recording request.
...
func (s *CloudRecordingService) HandleStopRecording(stopReq StartRecordingRequest, w http.ResponseWriter){
